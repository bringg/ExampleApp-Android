    ...
    private void initViews() {
        ...
        mTvAddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                WaypointActionUtil.navigate(view.getContext(), mWaypoint.getLat(), mWaypoint.getLng());
            }
        });
        ...
        mBtnContactPhone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                WaypointActionUtil.makeCall(view.getContext(), mWaypoint.getPhone());
            }
        });
        mBtnContactMessage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                WaypointActionUtil.contactMessage(view.getContext(), mWaypoint.getPhone());
            }
        });
        mBtnAction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                WaypointActionUtil.proceedToNextTaskStep(WayPointFragment.this, mTask, mWaypoint.getId());
            }
        });
